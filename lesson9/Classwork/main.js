...
//     memberDiv.innerHTML = `${simpson.name}  ${simpson.surname} - ${simpson.age}`;
...
for (let simpson of simpsons) {
    ...
    memberDiv.append(nameDiv,surnameDiv,ageDiv,infoDiv,img);
    document.body.appendChild(memberDiv);
}
// - Є масив
let coursesArray = [
...
for (let item of coursesArray) {
   ...
   divHours.innerText = item.hourDuration;
   ...
   let ul = document.createElement("ul")
    ...
    divItem.append(divTitle,divMonth,divHours,divModules);
